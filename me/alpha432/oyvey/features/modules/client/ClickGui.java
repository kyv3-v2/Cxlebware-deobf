...
public class ClickGui extends Module
{
    ...
    public ClickGui() {
        ...
        this.topRed = (Setting<Integer>)this.register(new Setting("SecondRed", (T)80, (T)0, (T)255));
        this.topGreen = (Setting<Integer>)this.register(new Setting("SecondGreen", (T)0, (T)0, (T)255));
        this.topBlue = (Setting<Integer>)this.register(new Setting("SecondBlue", (T)185, (T)0, (T)255));
